...
class ChangeLoginPinScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      mmyy_txt:"",
  ...
  async onSubmit() {
    if (this.state.account_type_val === -1) {
      ...
      Utility.alert("Please enter expiry date");
    }
    else if (this.state.et_pin === "") {
      Utility.alert("Please enter card  pin");
    }
    else if (this.state.new_pin_txt === "") {
      Utility.alert("Please enter new password");
    } else if (this.state.confirm_pin_txt === "") {
            ...
            <View style={{
              ...
              <View style={{
                ...
                <TextInput
                  ...
                  placeholder={language.new_pin_txt}
                  onChangeText={text => this.setState({ new_pin_txt: text })}
                  value={this.state.new_pin_txt}
                  multiline={false}
                  numberOfLines={1}
                  keyboardType={"number-pad"}
                  contextMenuHidden={true}
              ...
              <View style={{
                ...
                <TextInput
                  ...
                  placeholder={language.confirm_pin_txt}
                  onChangeText={text => this.setState({ confirm_pin_txt: text })}
                  value={this.state.confirm_pin_txt}
                  multiline={false}
                  numberOfLines={1}
                  contextMenuHidden={true}
                  placeholderTextColor={themeStyle.PLACEHOLDER_COLOR}
...
export default connect(mapStateToProps)(ChangeLoginPinScreen);
