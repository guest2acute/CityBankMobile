...
class ForgotPinScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            acc_no_val: -1,
    ...
    async redirect() {
        Utility.alertWithBack("OK","Successfully updated");
    }
                                ...
                                {(this.state.account_type_val === 1 || this.state.isOTPSent) ? <View>
                                    ...
                                    <View style={{
                                        ...
                                        <TextInput
                                            ...
                                            placeholder={language.conf_new_pin}
...
export default connect(mapStateToProps)(ForgotPinScreen);
