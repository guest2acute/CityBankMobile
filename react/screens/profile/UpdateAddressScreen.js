...
let address_type = [
  { label: "Change Present Address", value: 0 },
  { label: "Change Communication Address", value: 1 },
];
    ...
    return (<View style={{ flex: 1, backgroundColor: themeStyle.BG_COLOR }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}
        ...
        <View style={{
          ...
          <Text style={[styles.labelStyle, { marginTop: hp(dimen.dim_h20) }]}>Address Type</Text>
          <DropDownPicker
            style={{ flex: 1 }}
            ...
            onChangeItem={item => this.setState({ address_val: item.value })}
          />


          <Text style={styles.labelStyle}>Present Address</Text>
          <View style={{
            ...
            <TextInput
              ...
              placeholder={language.present_address}
              onChangeText={text => {
                this.setState({ present_address: text });
              }}
          ...
          <Text style={styles.labelStyle}>Communication Address</Text>
          <View style={{
            height: hp(dimen.dim_h100),
            flex: 1,
            borderRadius: 2,
            ...
            <TextInput
              ...
              placeholder={language.communication_address}
              onChangeText={text => {
                this.setState({ communication_address: text });
              }}
...
export default connect(mapStateToProps)(UpdateAddressScreen);
