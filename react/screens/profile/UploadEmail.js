    ...
    return (<View style={{ flex: 1, backgroundColor: themeStyle.BG_COLOR }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}
        ...
        <View style={{
          ...
          <Text style={styles.labelStyle}>{language.current_email}</Text>
          <View style={{
            height: hp(dimen.dim_h50),
            flex: 1,
            borderRadius: 2,
            ...
            <TextInput
              ...
              placeholder={language.current_email}
              onChangeText={text => this.setState({ current_email: text })}
          ...
          <Text style={styles.labelStyle}>{language.new_email}</Text>
          <View style={{
            height: hp(dimen.dim_h50),
            flex: 1,
            borderRadius: 2,
            ...
            <View style={{
              ...
              <TouchableOpacity style={{
                ...
                marginEnd: 10,
                                ...
                                onPress={() => {
                                  Utility.alertWithBack("Ok", "Email updated successfully", this.props.navigation);
                                }
                                }>
                <Text style={{
                  color: "#fff",
...
export default connect(mapStateToProps)(UploadEmail);
