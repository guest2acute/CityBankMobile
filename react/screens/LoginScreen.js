...
class LoginScreen extends Component {
  ...
  async redirect() {
    this.props.navigation.replace("EditProfileScreen", { language: this.props.language, screenFrom: "login",userid:this.state.userid });
  }
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: themeStyle.BG_COLOR }}>
        <SafeAreaView />
        {/*<View style={{ flexDirection: "row", marginTop: hp(dimen.dim_h20),marginLeft: wp(dimen.dim_w20),
          marginRight: wp(dimen.dim_w20), }}>
          <View style={{ flex: 1 }} />

          <TouchableOpacity disabled={this.props.langId === "en"} onPress={() => this.changeLanguage("en")}>
            <Text style={{
              color: this.props.langId === "en" ? themeStyle.GRAY_COLOR : themeStyle.HIGHLIGHT_COLOR,
              fontSize: FontSize.getSize(14),
              textAlign: "center",
              textDecorationLine: this.props.langId !== "en" ? "underline" : "none",
              fontFamily: this.props.langId !== "en" ? FontStyle.RobotoMedium : FontStyle.RobotoRegular,
          ...
          <TouchableOpacity disabled={this.props.langId !== "en"} onPress={() => this.changeLanguage("bangla")}>
            <Text style={{
              color: this.props.langId === "en" ? themeStyle.HIGHLIGHT_COLOR : themeStyle.GRAY_COLOR,
              fontSize: FontSize.getSize(15),
              textAlign: "center",
              textDecorationLine: this.props.langId === "en" ? "underline" : "none",
              fontFamily: this.props.langId === "en" ? FontStyle.RobotoMedium : FontStyle.RobotoRegular,
