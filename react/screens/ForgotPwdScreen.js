...
class ForgotUIDScreen extends Component {
    ...
    async onSubmit() {
        if (this.state.userid === "") {
            ...
            } else if (this.state.pwdVal === "") {
                Utility.alert("Please enter password");
            } else if (this.state.pwdVal.length !== this.state.conf_pwdVal.length) {
                Utility.alert("Mismatch Confirm password and password ");
            } else
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <DropDownPicker
                                ...
                                onChangeItem={item =>
                                    this.setState({
                                        account_type_val: item.value, pwdVal: "",
                                        conf_pwdVal: "",
                                    })}
                            />
                                ...
                                {(this.state.account_type_val === 1 || this.state.isOTPSent) ? <View>
                                    <View style={{
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={text => this.setState({pwdVal: text})}
                                    ...
                                    <View style={{
                                        ...
                                        <TextInput
                                            ...
                                            placeholder={language.conf_new_pass_txt}
                                            onChangeText={text => this.setState({conf_pwdVal: text})}
                                            value={this.state.conf_pwdVal}
                                            multiline={false}
                                            numberOfLines={1}
                                            contextMenuHidden={true}
                                            placeholderTextColor={themeStyle.PLACEHOLDER_COLOR}
